...
LA_INLINE void lamm_simd_kernel(const block_q2_K *a, const block_q8_K *b,
  ...
  for (int k = 0; k < K; k++, aik++, bjk++) {
    ...
    const hivreg_t mins_and_scales = loadh(reinterpret_cast<const char*>(aik->scales));
    ...
    const ivreg_t scales[2] = {concat(l_scales, l_scales), concat(h_scales, h_scales)};
    ...
    for (int j = 0; j < 2; ++j) {
      ...
      // for a
      const ivreg_t q2bits = load(q2); q2 += 32;
...
LA_INLINE void lamm_simd_block_kernel(const block_q2_K *a, const block_q8_K *b,
  ...
  [[maybe_unused]] ivreg_t q8_00[2] = {0}, q8_01[2] = {0}, q8_02[2] = {0}, q8_03[2] = {0};
  [[maybe_unused]] ivreg_t q8_10[2] = {0}, q8_11[2] = {0}, q8_12[2] = {0}, q8_13[2] = {0};
  [[maybe_unused]] ivreg_t q8_20[2] = {0}, q8_21[2] = {0}, q8_22[2] = {0}, q8_23[2] = {0};
  [[maybe_unused]] ivreg_t q8_30[2] = {0}, q8_31[2] = {0}, q8_32[2] = {0}, q8_33[2] = {0};

  [[maybe_unused]] ivreg_t bsum0 = {0}, bsum1 = {0}, bsum2 = {0}, bsum3 = {0};
  [[maybe_unused]] vreg_t bd0 = {0}, bd1 = {0}, bd2 = {0}, bd3 = {0};

  [[maybe_unused]] ivreg_t sumi00 = {0}, sumi01 = {0}, sumi02 = {0}, sumi03 = {0};
  [[maybe_unused]] ivreg_t sumi10 = {0}, sumi11 = {0}, sumi12 = {0}, sumi13 = {0};
  [[maybe_unused]] ivreg_t sumi20 = {0}, sumi21 = {0}, sumi22 = {0}, sumi23 = {0};
  [[maybe_unused]] ivreg_t sumi30 = {0}, sumi31 = {0}, sumi32 = {0}, sumi33 = {0};
...
#define OUTER_FN(N0)                                                           \
  if constexpr (B0 > N0) {                                                     \
    ...
    const hivreg_t mins_and_scales = loadh(reinterpret_cast<const char*>(ai##N0->scales)); \
    const hivreg_t scales8 = _and(mins_and_scales, m4); \
    const hivreg_t mins8 = _and(logic_shift_right(mins_and_scales, 4), m4); \
    const ivreg_t mins = extend(mins8); \
    const ivreg_t all_scales = extend(scales8); \
