#ifndef LAMM_KERNEL_Q4_0_HPP
#define LAMM_KERNEL_Q4_0_HPP
...
LA_INLINE void lamm_naive_kernel(const block_q4_0 *a, const block_q8_0 *b,
                                 float *c, int64_t lda, int64_t ldb,
                                 int64_t ldc, int i, int j, int K) {
  constexpr int Q = ggml_type_trait<GGML_TYPE_Q4_0>::super_block_size;
  float sum = 0.0;
  for (int k = 0; k < K; k++) {
...
LA_INLINE void lamm_simd_kernel(const block_q4_0 *a, const block_q8_0 *b,
...
LA_INLINE void lamm_simd_block_kernel(const block_q4_0 *a, const block_q8_0 *b,
                                      float *c, int64_t lda, int64_t ldb,
                                      int64_t ldc, int i, int j, int K) {
